...
// basic -: name,email,photo,password,passwordConfirm
const userSchema = new mongoose.Schema({
  ...
  active: {//only if any user model have this field means then only we will check it is changed before the token given or after
    type: Boolean,
    default: true,//active
    select: false//we don't want anyone to see this so like password we here also select true
  }
});

//this will refers to the current user

//-------All pre middleware are query middleware runs before every query-------
